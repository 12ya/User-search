...
import Navigation from './src/navigation/navigaiton';

/**
 *
 * 1. Researching/Setting up/Testing Github API endpoints in Postman ~1 hour
 * 2. Architecturing folder structure - 10 minutes
 * 3. Setting up Navigation - 10 minutes
